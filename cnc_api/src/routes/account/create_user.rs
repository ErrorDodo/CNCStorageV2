...
pub async fn create_user(
    ...
    let created_user_info = conn
        .transaction::<_, DieselError, _>(|conn| {
            ...
            // Return the invite details along with the user ID
            Ok((invite, user_id))
        })
        .map_err(|e| {
    ...
    // Log the details after successful user creation and invite update
    info!(
        "User Created Successfully: {}. Invite Code: {}, Generated by User ID: {}, Date Used: {}",
        user_dto.username,
        invite.invite_code,
        invite.generated_by_user_id,
        invite.date_used.unwrap()
    );
